...
const zhCN = {
  ...
  addMcp: {
    ...
    urlLabel: "MCP 服务地址",
    urlPlaceholder: "输入 MCP 服务 URL，如 https://example.com/mcp",
    urlNamePlaceholder: "服务名称（可选，默认提取域名）",
    urlDescriptionPlaceholder: "服务描述（可选）",
    inputMode: {
      json: "JSON 模式",
      url: "URL 模式",
    },
    errors: {
      ...
      urlEmpty: "请输入 MCP 服务地址",
      urlInvalid: "地址格式无效，请输入 http/https 开头的 URL",
    },
    submit: "+ 添加 MCP 服务",
    submitting: "添加中...",
    toast: {
